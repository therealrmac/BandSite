...
namespace BandSite.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MemberId,Name,Bio,Facebook,Twitter")] Members members)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MemberId,Name,Bio,Facebook,Twitter")] Members members)
        {
