...
namespace BandSite.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductTypeId,CategoryName")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductTypeId,CategoryName")] ProductType productType)
        {
